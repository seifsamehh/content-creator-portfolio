const Experience = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen gap-10 experience">
      <h2 className="text-center xs:text-9xl md:text-[12rem]">Experience</h2>
