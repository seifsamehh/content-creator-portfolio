const Experience = () => {
  return (
    <section className="flex flex-col items-center min-[290px]:justify-between md:justify-center min-h-screen gap-10 experience">
      <h2 className="text-center min-[290px]:text-6xl md:text-[12rem]">
        Experience
      </h2>
      <ol className="relative min-[290px]:mx-8 md:mx-0">
